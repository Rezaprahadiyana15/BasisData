...
<html lang="en">
  <head>
	...
	<script src="https://kit.fontawesome.com/348c585419.js" crossorigin="anonymous"></script>
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	          ...
	          <span class="sr-only">Toggle Menu</span>
				...
				<div class="p-2">
		  		<h1><a href="index.html" class="logo">WELCOME<span style="font-size: 12px;">UNIVERSITAS SULTAN AGENG TIRTAYASA</span></a></h1>
	        <ul class="list-unstyled components mb-3">
	          <li class="active">
	            <a href="#"><span class= "fa-solid fa-house-user mr-3"></span> Dashboard</a>
	          </li>
	          <li>
	              <a href="#"><span class="fa fa-user mr-3"></span> Penanggungjawab PT</a>
	          </li>
	          <li>
              <a href="#"><span class="fa-solid fa-bars-staggered mr-3"></span> Pengajuan Izin Kerja Sama</a>
	          </li>
	          <li>
              <a href="#"><span class="fa-solid fa-gears mr-3"></span>Pengaturan</a>
	          </li>
	          <li>
              <a href="#"><span class="fa-solid fa-arrow-right-from-bracket mr-3"></span>Logout</a>
	          </li>
	          <li>
	        </ul>
	        ...
	        <div class="footer mt-7">
	        	<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Kelompok 9 &copy;<script>document.write(new Date().getFullYear());</script>
	...
	<form class="needs-validation" novalidate action="proses.php" method="post">
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<div>
				<table style="background-color: rgb(23, 214, 205);">
					<tr>
